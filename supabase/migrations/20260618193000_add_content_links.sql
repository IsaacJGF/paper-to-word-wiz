...
GRANT UPDATE (conteudo) ON public.questions TO anon, authenticated;

DROP POLICY IF EXISTS "Allow question content updates from app" ON public.questions;
CREATE POLICY "Allow question content updates from app"
ON public.questions
FOR UPDATE
